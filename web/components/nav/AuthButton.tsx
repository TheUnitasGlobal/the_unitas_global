  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 border border-accent/50 bg-void/60 px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-widest text-accent transition-all hover:bg-accent hover:text-void"
      >
        {session ? <LogOut size={13} /> : <LogIn size={13} />}
