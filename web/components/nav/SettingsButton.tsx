  ...
  return (
    <>
      <button
        ...
        className="relative flex h-11 w-11 items-center justify-center border border-accent/50 bg-void/60 text-accent transition-all hover:bg-accent hover:text-void"
      >
        <Settings size={20} />
