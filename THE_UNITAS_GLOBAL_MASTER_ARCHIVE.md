...
Last synchronized: 2026-08-29 (Rev 1 — 최상위 운영 헌법 각인)
...
이 헌법은 이 저장소에서 활동하는 모든 AI 엔진(Claude Code, GitHub Copilot, Continue, Roo Code, aider, `.github/agents/*`)에 예외 없이 적용되며, 개별 엔진 규칙과 충돌하면 이 헌법이 우선한다. 정본은 `CLAUDE.md` §0, 이 문서, `.roo/rules/unitas-constitution.md`에 동일하게 각인되어 있다.
