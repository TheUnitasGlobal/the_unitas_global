...
Last synchronized: 2026-08-31 (Rev 6 — [유니타스 경영 지침서 (통합)] 전면 각인: 제1~6장 통합 코덱스로 §0 본문 교체. 주의: 원문 제2장의 43~57 구간이 Rev 5에서 고친 초경제적·초예방적 중복을 재도입하고 있어 정합성 각주로 병기함)
...
이 헌법은 이 저장소에서 활동하는 모든 AI 엔진(Claude Code, GitHub Copilot, Continue, Roo Code, aider, `.github/agents/*`)에 예외 없이 적용되며, 개별 엔진 규칙과 충돌하면 이 헌법이 우선한다. 정본은 루트 `CLAUDE.md`, `CLAUDE.md`(운영 루트), 이 문서, `.roo/rules/unitas-constitution.md`에 동일하게 각인되어 있다.
