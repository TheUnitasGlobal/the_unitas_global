...
description: Review THE UNITAS GLOBAL changes for security, Supabase, Stripe, and deployment risks. Security lens of the sovereign role pipeline (Planner→TDD-Guide→Code-Reviewer→Security-Reviewer), driven by Claude Code as the sole governing agent under Codex v57.0 제4장. (Renamed from unitas-claude-reviewer — the vendor-era name outlived the vendor selector that 제4장 destroyed.)
---
