...
> 이 파일이 `.roo/rules/`에 있다는 사실은 Roo Code 연동을 뜻하지 않는다. Codex v41.0 제4장은 보조 에이전트 CLI 연동을 영구 배제하며, 이 디렉터리는 그와 무관하게 **헌법 정본 3파일 중 하나(`unitas-constitution.md`)가 사는 독트린 경로**다.
